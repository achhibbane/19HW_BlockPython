...
#BTCTEST send transaction
account_0 = priv_key_to_account(BTCTEST, coins[BTCTEST][0]['privkey'])
account_1 = priv_key_to_account(BTCTEST, coins[BTCTEST][1]['privkey'])   
    
#ETH send transaction
account_0 = priv_key_to_account(ETH, coins[ETH][0]['privkey'])
account_1 = priv_key_to_account(ETH, coins[ETH][1]['privkey'])

#BTCTEST
send_tx(BTCTEST, account_0, account_1 , 0.000)

#ETH 
send_tx(ETH, account_0, '0x1050c67382bb210a3b620df16da455a62cff22e2' , 2333444)
